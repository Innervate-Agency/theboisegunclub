#!/usr/bin/env python3
"""
AI CONTENT GENERATOR WITH OLLAMA - CLEAN VERSION
================================================
...
class OllamaAIContentGenerator:
    ...
    def create_business_prompt(self, business: dict) -> str:
        """Create authentic Idaho voice prompt"""
        ...
        # SIMPLE, AUTHENTIC IDAHO PROMPT
        prompt = f"""Write a business description for an Idaho firearms/outdoor directory. Sound like a local neighbor recommending to friends, not a corporation.

{context}

Instructions:
- Write 150-200 words in conversational Idaho voice
- Use "folks" not "customers" 
- Sound like you actually know this place and area
- Reference Idaho outdoor lifestyle naturally
- Include practical location/service details
- NO corporate buzzwords: avoid "trusted source", "wide selection", "knowledgeable staff", "commitment to excellence", "hidden gem"
...
Write only the business description."""
    ...
    def validate_generated_content(self, content: str, business: dict) -> dict:
        ...
        # Check for contact info (shouldn't be there)
    ...
    def generate_business_content(self, business: dict) -> dict:
        """Generate AI content for single business"""
        name = business["name"]
        ...
        if result["success"]:
            ...
            self.mark_business_generated(name, website, success=True, description_length=result["char_count"])
