  ...
  "inline-flex items-center justify-center font-noto-sans font-medium transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-sandy-ochre focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 whitespace-nowrap",
  {
    variants: {
      variant: {
        ...
        default: "bg-primary text-primary-foreground shadow-flat hover:shadow-md ",
        
        // Primary: Brand gradient with consistent shadows
        primary: "bg-gradient-to-r from-sandy-ochre to-rusty-orange text-dark-chocolate shadow-flat hover:shadow-md  font-semibold",
        
        // Secondary: Walnut-themed with shadow depth
        secondary: "bg-walnut-stock text-nickel-white shadow-flat hover:shadow-md  hover:bg-walnut-stock/90",
        ...
        destructive: "bg-muzzle-flash text-nickel-white shadow-flat hover:shadow-md  hover:bg-muzzle-flash/90",
        
        // Success: Shadow-first approach
        success: "bg-bore-sight-green text-nickel-white shadow-flat hover:shadow-md  hover:bg-bore-sight-green/90",
        
        // Warning: Clean shadow hierarchy
        warning: "bg-sight-gold text-dark-chocolate shadow-flat hover:shadow-md  hover:bg-sight-gold/90",
      },
      size: {
