  ...
  "relative rounded-none p-md transition-all duration-300 ease-out",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card border border-border/30 shadow-elevated hover:shadow-elevated relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-1.5 after:bg-gradient-to-r after:from-rusty-orange after:to-sandy-ochre after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-sm"
      }
    },
    defaultVariants: {
      variant: "default"
