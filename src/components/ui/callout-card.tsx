  ...
  "relative rounded-card p-[var(--space-md)] transition-all duration-300 ease-out",
  {
    variants: {
      variant: {
        ...
        default: "bg-card shadow-flat hover:shadow-md relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-1.5 after:bg-gradient-to-r after:from-copper-orange after:to-brass-yellow after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-lg",
        subtle: "bg-muted shadow-flat hover:shadow-md hover:bg-card",
        animated: "bg-card shadow-flat hover:shadow-md relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-1.5 after:bg-gradient-to-r after:from-copper-orange after:to-brass-yellow after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-lg before:absolute before:inset-0 before:bg-gradient-to-br before:from-brass-yellow/4 before:via-transparent before:to-copper-orange/3 before:rounded-card before:pointer-events-none",
        important: "bg-card shadow-flat hover:shadow-md relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-2 after:bg-gradient-to-r after:from-safety-red after:to-muzzle-flash after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-lg before:absolute before:inset-0 before:bg-gradient-to-br before:from-safety-red/6 before:via-transparent before:to-muzzle-flash/4 before:rounded-card before:pointer-events-none",
        info: "bg-card shadow-flat hover:shadow-md relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-1.5 after:bg-gradient-to-r after:from-scope-blue after:to-ayu-blue after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-lg before:absolute before:inset-0 before:bg-gradient-to-br before:from-scope-blue/4 before:via-transparent before:to-ayu-blue/3 before:rounded-card before:pointer-events-none",
        glass: "mica-card shadow-flat hover:shadow-md relative after:absolute after:bottom-[-1px] after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-1.5 after:bg-gradient-to-r after:from-copper-orange after:to-brass-yellow after:transition-all after:duration-300 after:ease-out hover:after:w-full after:rounded-b-lg"
      }
    },
    defaultVariants: {
      variant: "default"
      ...
      <div className="relative space-y-[var(--space-sm)]">
        <div className="space-y-[var(--space-xs)]">
          <div>
            ...
            {description && (
              <p className="text-body-sm text-muted-foreground font-noto-sans leading-relaxed">
                {description}
              </p>
            )}
          </div>
