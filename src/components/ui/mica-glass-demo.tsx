...
export function MicaGlassDemo({ className }: MicaDemoProps) {
  return (
    <div className={cn("w-full max-w-site mx-auto p-lg space-y-(--space-lg)", className)}>
      <div className="text-center space-y-(--space-base)">
        ...
        <div className="relative space-y-(--space-md)">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-md">
            ...
            <Card className="mica-card relative z-10">
              ...
              <CardContent>
                <p className="text-body-sm text-muted-foreground mb-(--space-base)">
            ...
            <Card className="mica-card-premium relative z-10">
              <CardHeader>
                <Badge variant="premium" className="w-fit mb-(--space-xs)">Premium</Badge>
            ...
            <div className="mica-overlay p-md rounded-card relative z-10">
              <h4 className="font-rajdhani font-bold text-foreground mb-(--space-sm)">Mica Overlay</h4>
              <p className="text-body-sm text-muted-foreground mb-(--space-base)">
      ...
      <div className="space-y-(--space-md)">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
          ...
          <div className="relative">
            ...
            <div className="relative space-y-(--space-base)">
              <h4 className="text-body-lg font-medium text-dark-chocolate text-center mb-(--space-base)">
                ✅ Perfect for Glassmorphism
              </h4>
              
              {/* Dropdown Simulation */}
              <div className="mica-dropdown p-base rounded-card relative z-10">
                <h5 className="font-medium mb-(--space-xs)">Dropdown Menu</h5>
              ...
              <div className="mica-modal p-base rounded-card relative z-10">
                <h5 className="font-medium mb-(--space-xs)">Modal Dialog</h5>
                <p className="text-body-sm text-muted-foreground">
          ...
          <div className="space-y-(--space-base)">
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-base">
                <h5 className="font-medium mb-(--space-xs)">Content Card</h5>
                <p className="text-body-sm text-muted-foreground">
            ...
            <Card className="bg-solid-brand-warm hover-gradient-warm border-sandy-ochre/20">
              <CardContent className="p-base">
                <h5 className="font-medium mb-(--space-xs)">Interactive Card</h5>
                <p className="text-body-sm text-muted-foreground">
        ...
        <div className="relative space-y-(--space-md)">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-base">
            <div className="mica-dropdown p-base rounded-card">
              <h4 className="font-medium text-foreground mb-(--space-xs)">Dropdown Style</h4>
              <p className="text-body-sm text-muted-foreground">
            ...
            <div className="mica-modal p-base rounded-card">
              <h4 className="font-medium text-foreground mb-(--space-xs)">Modal Style</h4>
              <p className="text-body-sm text-muted-foreground">
      ...
      <div className="bg-solid-brand-neutral p-md rounded-large border border-sandy-ochre/20">
        <h4 className="text-body-lg font-rajdhani font-bold text-dark-chocolate mb-(--space-base)">
          Design Token Reference
        </h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-base text-body-sm font-noto-sans">
          <div>
            <h5 className="font-medium text-warning-amber mb-(--space-xs)">Mica Classes</h5>
            <ul className="space-y-(--space-micro) text-muted-foreground">
          ...
          <div>
            <h5 className="font-medium text-warning-amber mb-(--space-xs)">Gradient Backgrounds</h5>
            <ul className="space-y-(--space-micro) text-muted-foreground">
          ...
          <div>
            <h5 className="font-medium text-warning-amber mb-(--space-xs)">Hover Effects</h5>
            <ul className="space-y-(--space-micro) text-muted-foreground">
