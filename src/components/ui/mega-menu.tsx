...
import { ArrowRightIcon, BookOpenIcon, BuildingStorefrontIcon, CalendarDaysIcon, EyeIcon, MapIcon, MapPinIcon, ShieldCheckIcon, ShoppingBagIcon, StarIcon, TicketIcon, UsersIcon } from '@heroicons/react/24/outline';
...
const megamenuSections: MegamenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/buysell', label: 'All Listings', description: 'Browse everything', icon: ShoppingBagIcon },
...
export function MegaMenuComponent({ 
  isOpen, 
  onClose, 
  activeSection,
  className 
