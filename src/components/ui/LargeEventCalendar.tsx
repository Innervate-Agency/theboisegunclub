      ...
      <div className="py-3xl bg-background">
        <div className="container mx-auto max-w-site px-lg">
          <div className="space-y-2xl">
            ...
            {/* Massive Calendar */}
            <div className="bg-card rounded-large p-2xl shadow-md">
              <Calendar
                mode="single"
                ...
                classNames={{
                  ...
                  head_row: "mb-lg",
                  head_cell: "text-muted-foreground font-rajdhani font-bold text-2xl h-16 text-center",
                  row: "mb-sm",
            ...
            {selectedDate && selectedDateEvents.length > 0 && (
              <div className="space-y-lg">
                <h3 className="font-rajdhani text-3xl font-bold text-card-foreground text-center">
                        ...
                        <CardContent className="p-lg space-y-base">
                          <div className="flex items-start justify-between">
                            <div className="flex items-center gap-sm">
                              <div className={`p-sm rounded-lg bg-${config.color}/20`}>
                          ...
                          <h4 className="font-rajdhani text-xl font-bold text-card-foreground">
                            {event.title}
                          </h4>
            ...
            {selectedDate && selectedDateEvents.length === 0 && (
              <div className="text-center py-3xl">
                ...
                <h3 className="font-rajdhani text-2xl font-bold text-card-foreground mb-base">
                  No Events Scheduled
                </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-lg">
              <Card className="text-center p-lg">
                <div className="font-rajdhani text-4xl font-bold text-rusty-orange">
                  {monthEvents.length}
                </div>
                <div className="text-muted-foreground">Events This Month</div>
              </Card>
              <Card className="text-center p-lg">
                <div className="font-rajdhani text-4xl font-bold text-sage-green">
                  {monthEvents.filter(e => e.featured).length}
                </div>
                <div className="text-muted-foreground">Featured Events</div>
              </Card>
              <Card className="text-center p-lg">
                <div className="font-rajdhani text-4xl font-bold text-slate-blue">
