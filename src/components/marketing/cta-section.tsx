      ...
      <div className="container mx-auto px-[var(--space-base)]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Card className="bg-card shadow-md border border-case-hardened/20 p-[var(--space-lg)] mb-[var(--space-xl)]">
            <h2 className="font-rajdhani text-heading-lg md:text-heading-xl font-bold text-gunmetal-black mb-[var(--space-md)]">
              Get Notified When We Launch
            </h2>
            <p className="font-noto-sans text-body-lg text-case-hardened leading-relaxed mb-[var(--space-lg)] max-w-2xl mx-auto">
          ...
          {/* Vision statement */}
          <div className="space-y-[var(--space-md)] font-noto-sans text-body text-case-hardened leading-relaxed max-w-3xl mx-auto">
            <p>
            ...
            <p className="font-serif italic text-body-lg text-case-hardened/80">
