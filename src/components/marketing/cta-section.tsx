      ...
      <div className="container mx-auto px-(--spacing-base)">
        <div className="max-w-site mx-auto text-center">
          ...
          <Card className="bg-card shadow-md border border-warning-amber/20 p-(--spacing-lg) mb-(--spacing-xl)">
            ...
            <p className="font-noto-sans text-body-lg text-warning-amber leading-relaxed mb-(--spacing-lg) max-w-2xl mx-auto">
          ...
          {/* Vision statement */}
          <div className="space-y-(--spacing-md) font-noto-sans text-body text-warning-amber leading-relaxed max-w-3xl mx-auto">
            <p>
