...
/**
 * DirectoryVerificationContent - Pure Content Component
 * 
 * OPTIMIZED FOR MVP:
 * - Stripped all layout concerns (navigation, background, min-height)
 * - Layout component will handle structural decisions
 * - Clear explanation of Idaho firearms business verification process
 * - Professional and trustworthy presentation of verification tiers
 * - Idaho-specific language and values ("straight talk, firm handshake")
 */
export function DirectoryVerificationContent() {
  return (
    <div className="container mx-auto max-w-4xl py-2xl px-md">
      <div className="space-y-lg">
        <div className="text-center">
          ...
          <h1 className="font-rajdhani h1-primary mt-base">Our Verification Process</h1>
        ...
        <div>
          <h2 className="font-rajdhani h2-section text-center mb-lg">Our Verification Tiers</h2>
