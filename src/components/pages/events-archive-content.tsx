...
/**
 * EventsArchiveContent - Pure Content Component
 * 
 * OPTIMIZED FOR MVP:
 * - Stripped all layout concerns (backgrounds, containers, min-height)
 * - Layout component will handle structural decisions
 * - Clean archive browsing with year grouping
 * - Future feature previews for roadmap visibility
 */
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
              <div className="bg-white/10 rounded-xs p-4">
                <div className="h3-subsection">{totalEvents}</div>
                <div className="text-sm text-white/80">Total Events</div>
              </div>
              <div className="bg-white/10 rounded-xs p-4">
                <div className="h3-subsection">{competitions}</div>
                <div className="text-sm text-white/80">Competitions</div>
              </div>
              <div className="bg-white/10 rounded-xs p-4">
                <div className="h3-subsection">{trainingSessions}</div>
                <div className="text-sm text-white/80">Training Sessions</div>
              </div>
              <div className="bg-white/10 rounded-xs p-4">
                <div className="h3-subsection">{totalParticipants}</div>
