      ...
      <Card className="text-center p-8 bg-gradient-mesh-premium">
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-8 pt-6 border-t">
            ...
            <div className="text-center">
              <div className="text-2xl font-rajdhani font-bold text-copper-orange">98.5%</div>
              <div className="text-sm text-muted-foreground">Safety Rating</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-rajdhani font-bold text-ayu-blue">24/7</div>
              <div className="text-sm text-muted-foreground">Range Access</div>
            </div>
          </div>
        </CardContent>
      </Card>
