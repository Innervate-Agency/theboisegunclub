  ...
  render: () => (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <div className="grid gap-sm p-md md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <NavigationMenuLink href="/intro" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                <div className="text-body-sm font-medium leading-none">Introduction</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
                  Learn about our shooting club and facilities.
                </p>
              </NavigationMenuLink>
              <NavigationMenuLink href="/installation" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                <div className="text-body-sm font-medium leading-none">Membership</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
                  Join our club and access premium features.
                </p>
              </NavigationMenuLink>
              <NavigationMenuLink href="/docs/primitives/typography" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                <div className="text-body-sm font-medium leading-none">Safety Rules</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
        ...
        <NavigationMenuItem>
          <NavigationMenuLink href="/docs" className="group inline-flex h-9 w-max items-center justify-center rounded-input bg-background px-base py-xs text-body-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50">
            Documentation
          </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <div className="grid gap-sm p-md md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <NavigationMenuLink variant="tournament" href="/tournament/leaderboard" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none text-range-white">
                  <div className="text-body-sm font-medium leading-none">Live Leaderboard</div>
                  <p className="line-clamp-2 text-body-sm leading-snug text-stainless-steel">
                    Real-time tournament standings and scores.
                  </p>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/tournament/officials" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none text-range-white">
                  <div className="text-body-sm font-medium leading-none">Officials Panel</div>
                  <p className="line-clamp-2 text-body-sm leading-snug text-stainless-steel">
                    Tournament official controls and communications.
                  </p>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/tournament/broadcast" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none text-range-white">
                  <div className="text-body-sm font-medium leading-none">Broadcast Control</div>
                  <p className="line-clamp-2 text-body-sm leading-snug text-stainless-steel">
    ...
    <NavigationMenu variant="minimal">
      <NavigationMenuList variant="minimal">
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <div className="grid gap-sm p-base md:w-[400px] lg:w-[500px]">
              <NavigationMenuLink variant="minimal" href="/about" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none">
                <div className="text-body-sm font-medium leading-none">Club History</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
                  Learn about our club's rich history and traditions.
                </p>
              </NavigationMenuLink>
              <NavigationMenuLink variant="minimal" href="/mission" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none">
                <div className="text-body-sm font-medium leading-none">Our Mission</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
                  Understanding our goals and community values.
                </p>
              </NavigationMenuLink>
              <NavigationMenuLink variant="minimal" href="/facilities" className="block select-none space-y-micro rounded-input p-sm leading-none no-underline outline-none">
                <div className="text-body-sm font-medium leading-none">Facilities</div>
                <p className="line-clamp-2 text-body-sm leading-snug text-muted-foreground">
        ...
        <NavigationMenuItem>
          <NavigationMenuLink variant="minimal" href="/events" className="group inline-flex h-9 w-max items-center justify-center rounded-none px-base py-xs text-body-sm font-medium">
            Events
          </NavigationMenuLink>
        </NavigationMenuItem>
        <NavigationMenuItem>
          <NavigationMenuLink variant="minimal" href="/contact" className="group inline-flex h-9 w-max items-center justify-center rounded-none px-base py-xs text-body-sm font-medium">
            Contact
          </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
...
export const SiteNavigationPreset: Story = {
  ...
  render: () => (
    <div className="space-y-lg">
      <div>
        <h3 className="font-semibold mb-base">Main Site Navigation</h3>
              ...
              <NavigationMenuContent>
                <div className="grid gap-sm p-base md:w-[400px] lg:w-[500px]">
                  <NavigationMenuLink href="/tournaments/upcoming">
                    <div className="text-body-sm font-medium">Upcoming Events</div>
                  </NavigationMenuLink>
                  <NavigationMenuLink href="/tournaments/results">
                    <div className="text-body-sm font-medium">Results</div>
                  </NavigationMenuLink>
                </div>
              </NavigationMenuContent>
            </TournamentNavigationItem>
    ...
    <MainNavigation>
      <NavigationMenuList>
        ...
        <TournamentNavigationItem>
          ...
          <NavigationMenuContent>
            <div className="grid gap-sm p-base md:w-[400px] lg:w-[500px] lg:grid-cols-2">
              <NavigationMenuLink href="/tournaments">
                <div className="text-body-sm font-medium">Tournament Schedule</div>
                <p className="text-caption text-muted-foreground">View upcoming competitions</p>
              </NavigationMenuLink>
              <NavigationMenuLink href="/results">
                <div className="text-body-sm font-medium">Results Archive</div>
                <p className="text-caption text-muted-foreground">Past tournament results</p>
              </NavigationMenuLink>
              <NavigationMenuLink href="/leaderboards">
                <div className="text-body-sm font-medium">Leaderboards</div>
                <p className="text-caption text-muted-foreground">Current standings</p>
              </NavigationMenuLink>
              <NavigationMenuLink href="/registration">
                <div className="text-body-sm font-medium">Register</div>
                <p className="text-caption text-muted-foreground">Sign up for events</p>
              </NavigationMenuLink>
            </div>
          </NavigationMenuContent>
        </TournamentNavigationItem>
