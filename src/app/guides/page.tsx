...
function ArticleCard({ article }: { article: typeof knowledgeBaseArticles[0] }) {
  const categoryColors = {
    ...
    "Buying Guide": "bg-brass-yellow/20 text-brass-yellow border-brass-yellow/30",
    ...
    "Maintenance": "bg-copper-orange/20 text-copper-orange border-copper-orange/30"
  }

  const difficultyColors = {
    "Beginner": "bg-clubhouse-lawn-green/20 text-clubhouse-lawn-green border-clubhouse-lawn-green/30",
    "Intermediate": "bg-brass-yellow/20 text-brass-yellow border-brass-yellow/30", 
    "Advanced": "bg-safety-red/20 text-safety-red border-safety-red/30"
  }

  return (
    <Card className={`group hover:shadow-lg transition-all duration-300 ${
      article.featured ? 'ring-2 ring-brass-yellow/30 bg-brass-yellow/5' : ''
    }`}>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center space-y-lg">
            ...
            <h1 className="font-rajdhani text-6xl md:text-7xl font-bold text-range-white leading-tight">
              Idaho Firearms <span className="text-brass-yellow">Guides</span>
            </h1>
        ...
        <div className="container mx-auto max-w-4xl px-md text-center">
          <div className="space-y-lg">
            ...
            <h2 className="font-rajdhani text-4xl md:text-5xl font-bold text-range-white">
              Never Miss an <span className="text-brass-yellow">Update</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-base justify-center max-w-md mx-auto">
              <Input 
                ...
                className="bg-white/10 border-brass-yellow/30 text-range-white placeholder:text-range-white/60"
              />
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-brass-yellow to-copper-orange text-gunmetal-black hover:from-copper-orange hover:to-brass-yellow font-rajdhani font-bold"
