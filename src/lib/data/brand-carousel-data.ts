...
import { Target, Shield, Settings, Award, Zap, Users } from 'lucide-react';
...
export const defaultShowcases = [
  ...
  },
  {
    ...
    productsUsed: [
      { name: "Revolvers & Pistols", icon: "Shield", color: "bg-slate-blue" }
    ]
  },
  {
    companyName: "RUGER",
    ...
    productsUsed: [
      { name: "Sporting rifles", icon: "Award", color: "bg-sagebrush-green" }
    ]
  },
  {
    ...
    productsUsed: [
      { name: "Tactical systems", icon: "Settings", color: "bg-foothills-purple" }
    ]
  },
  {
    companyName: "LEUPOLD",
    ...
    productsUsed: [
      { name: "Precision optics", icon: "Zap", color: "bg-canyon-clay" }
    ]
  },
  {
    ...
    productsUsed: [
      { name: "Military systems", icon: "Users", color: "bg-sandy-ochre" }
    ]
  }
]
