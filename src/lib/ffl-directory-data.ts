...
export interface FFLBusinessData {
  ...
  operationalModel: 'Commercial BuildingStorefrontIcon' | 'Pawnbroker' | 'Home-Based/Appointment' | 'Manufacturer' | 'Training Facility'
...
export const adaCountyFFLs: FFLBusinessData[] = [
  // Major Commercial Storefronts
  {
    ...
    hours: "Mon-Fri 10AM-7PM, Sat 10AM-6PM, SunIcon 10AM-5PM",
    fflType: "Type 01 Dealer",
    verificationStatus: "Fully Verified",
    operationalModel: "Commercial BuildingStorefrontIcon",
    tier: "gold",
  ...
  },
  {
    ...
    phone: "(208) 377-2535",
    hours: "Tue-Fri 9AM-6PM, Sat 10AM-5PM, Closed Mon/SunIcon",
  ...
  // Home-Based/Appointment Only
  {
    ...
    address: "StarIcon, Idaho (appointment only)",
    phone: "(208) 286-7300",
...
export const canyonCountyFFLs: FFLBusinessData[] = [
  ...
  },
  {
    ...
    phone: "(208) 546-0100",
    hours: "Mon-Sat 9AM-8PM, SunIcon 10AM-6PM",
    fflType: "Type 01 Dealer",
    verificationStatus: "Fully Verified",
    operationalModel: "Commercial BuildingStorefrontIcon",
    tier: "gold",
  ...
  },
  {
    ...
    phone: "(208) 468-7600",
    hours: "Mon-Fri 9AM-9PM, Sat 8AM-9PM, SunIcon 10AM-6PM",
    fflType: "Type 01 Dealer",
  ...
  {
    businessName: "Mid StarIcon Firearms LLC",
...
export const fflDirectoryStats = {
  ...
  commercialStorefrontCount: allFFLs.filter(ffl => ffl.operationalModel === 'Commercial BuildingStorefrontIcon').length,
