...
export const shootingLocations = [
  // Designated Public Ranges - Idaho Fish & Game Managed
  {
    ...
    amenities: ["100-yard rifle range", "200-yard rifle range", "25-yard pistol range", "Shotgun pattern board", "Restrooms", "Parking for 50+ vehicles", "Covered shooting benches", "CursorArrowRaysIcon stands provided"],
  ...
  },
  {
    ...
    amenities: ["25-yard climate-controlled lanes", "Advanced ventilation system", "CursorArrowRaysIcon systems", "Rental firearms available", "Pro shop", "Gunsmith services", "Training classes", "Private instruction"],
  ...
  // BLM Dispersed Shooting Areas
  {
    ...
    restrictions: "Wildlife closure Feb 1 - July 31 in nesting areas. FireIcon restrictions May-October. Pack out all trash. No glass targets. 150-yard minimum from roads.",
  ...
  },
  {
    ...
    access: "Free BLM Access",
    hours: "Sunrise to sunset, year-round",
    restrictions: "Respect private property boundaries. FireIcon restrictions apply. No shooting within 150 yards of roads or trails. Pack out all trash.",
  ...
  },
  {
    ...
    restrictions: "Forest Service regulations. FireIcon restrictions May-September. No target shooting within 150 yards of water. Seasonal wildlife closures possible.",
  ...
  },
  {
    ...
    access: "Free BLM Access",
    hours: "Sunrise to sunset year-round",
    restrictions: "BLM regulations apply. FireIcon restrictions in summer. Pack out trash. No glass targets. Be aware of private property boundaries.",
  ...
  // Remote/Advanced Areas
  {
    ...
    restrictions: "4WD vehicle required. Inform others of plans. Carry emergency supplies. FireIcon restrictions critical. Remote area - no services.",
  ...
  // Northern Areas
  {
    ...
    restrictions: "Forest Service regulations. Seasonal road closures Nov-May. FireIcon restrictions summer. No target shooting within 150 yards of roads/trails/water.",
  ...
  },
  {
    ...
    access: "Free BLM Access",
    hours: "Sunrise to sunset year-round",
    restrictions: "BLM regulations. Respect wildlife refuge boundaries. FireIcon restrictions apply. No shooting near water areas.",
  ...
  // Central Idaho - Advanced
  {
    ...
    restrictions: "Mountain road access. Seasonal snow closures. Forest Service regulations. FireIcon restrictions critical. High elevation conditions.",
