...
@theme {
  ...
  --color-sandy-ochre: #D99F5D;
  --color-rusty-orange: #D9863B;
  --color-dark-chocolate: #1a0f0d;
  --color-nickel-white: #F9FAFB;
  ...
  --color-warning-amber: #696969;
  --color-muzzle-flash: #FFD700;
  --color-recoil-pad: #D3D3D3;
  --color-sight-gold: #CCCCCC;
...
const componentVariants = cva(
  ...
  "base-styles-here",
  {
    variants: {
      variant: {
        default: "bg-range-white text-dark-chocolate",
        primary: "bg-sandy-ochre text-dark-chocolate",
        secondary: "bg-card-surface text-dark-chocolate",
        accent: "bg-white text-dark-chocolate border-2 border-sandy-ochre/30",
        success: "bg-white text-dark-chocolate border-2 border-rifling-green/30",
        destructive: "bg-white text-dark-chocolate border-2 border-safety-red/30",
...
<p className="font-noto-sans text-sm text-warning-amber">
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
  <div className="text-left">
    <h2 className="font-rajdhani font-semibold text-2xl text-dark-chocolate">
      Heritage Preservation
    </h2>
    <p className="font-noto-sans text-base text-dark-chocolate mt-4">
...
const HeavyComponent = dynamic(() => import('./HeavyComponent'), {
  loading: () => <div className="animate-pulse bg-card-surface h-32 rounded-md" />,
  ssr: false,
})
```
